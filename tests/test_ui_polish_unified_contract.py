...
checks={
 ...
 "original pages use short workbench headings":'class="pane-heading original-heading"><h1>原始铅绘</h1>' in SKETCH and 'class="pane-heading original-heading"><h1>原始古风</h1>' in GRAPHIC and all('.original-content .hero{display:none!important}' in p for p in [SKETCH,GRAPHIC]),
 ...
 "idle generation buttons have visible borders":all(all(x in p for x in ['border-color:#aeb9ff','border-color:#a3d0c5']) for p in [MAIN,SKETCH,GRAPHIC]),
