...
checks={
 ...
 "batch semantics enforced without helper copy": 'id="batchNote" style="display:none"' in HTML and 'genBatch.disabled=staged' in HTML,
 "sequence disables batch": 'updateBatchSemantics' in HTML and 'genBatch.disabled=staged' in HTML,
 ...
 "staged mode one per stage": 'stage_job["batch"] = 1' in SERVER,
}
