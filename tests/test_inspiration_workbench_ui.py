...
checks={
 ...
 "right preview pane":all(x in HTML for x in ['class="preview-pane"','class="preview-stage"','你的创作将呈现在这里']),
 ...
 "all generation controls retained":all(x in HTML for x in ['id="genW"','id="genH"','id="genBatch"','id="genHd"','id="seedMode"','id="genSeed"','id="sketchProcess"']),
