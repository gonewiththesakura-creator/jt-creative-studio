...
html=html.replace('<button class="api-drawer-open" id="apiDrawerOpen" type="button">API生图</button>','<button class="api-drawer-open" id="apiDrawerOpen" type="button" aria-expanded="false" aria-controls="apiDrawer">API生图</button>')
