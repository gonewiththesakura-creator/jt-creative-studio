...
html=html.replace('__WORKBENCH_CSS__',WORKBENCH_CSS).replace('__BOOT_DATA__',BOOT_DATA).replace('__STYLE_CONFIG_URL__',STYLE_CONFIG_URL).replace('__DRAWERS__',DRAWS)
