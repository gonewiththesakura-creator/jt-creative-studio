...
@media(max-width:480px){.topbar-tools .connection-dot{display:none}.topbar-action{font-size:0;width:38px;padding:0}.topbar-action::first-letter{font-size:16px}.generation-actions{grid-template-columns:1fr}.settings{grid-template-columns:1fr 1fr}.preview-stage{min-height:390px;padding:10px}.result-tabs{width:100%}.result-tab{flex:1}}
...
</div><div class="creation-footer"><div class="generation-actions"><button class="primary generate" id="genCloudBtn">☁ 云端生图</button><button class="primary generate local" id="genLocalBtn">本地生成</button></div></div></aside>
...
<div class="library-overlay" id="histOverlay"><div class="library-panel"><div class="overlay-head"><h2>历史记录</h2><button class="close">×</button></div><div id="histList"></div></div></div><div class="library-overlay" id="favOverlay"><div class="library-panel"><div class="overlay-head"><h2>我的收藏</h2><button class="close">×</button></div><div id="favList"></div></div></div>
</div>
