...
.liquid-button{--liquid-color:#536cff;--liquid-level:108%;position:relative;isolation:isolate;overflow:hidden;border:1px solid transparent;color:#fff}.liquid-button.cloud{background:#fff;color:#4057e8;border-color:#aeb9ff;box-shadow:none}.liquid-button.local{--liquid-color:#3c9b82;background:#fff;color:#2f7866;border-color:#a3d0c5}.liquid-label{position:relative;z-index:3}.liquid-wave{position:absolute;z-index:1;left:-10%;bottom:-2px;width:120%;height:130%;background:var(--liquid-color);transform:translateY(var(--liquid-level));transition:transform 22s cubic-bezier(.16,.72,.23,1);pointer-events:none}.liquid-wave::before,.liquid-wave::after{content:"";position:absolute;left:50%;top:-18px;width:180%;height:38px;border-radius:42%;transform:translateX(-50%);background:rgba(255,255,255,.34);animation:liquid-wave 6s linear infinite}.liquid-wave::after{top:-12px;border-radius:47%;background:rgba(255,255,255,.18);animation-duration:9s;animation-direction:reverse}.liquid-button.is-loading{--liquid-level:5%;color:#fff}.liquid-button.is-loading.local{color:#fff}.liquid-button.is-loading .liquid-wave::before,.liquid-button.is-loading .liquid-wave::after{animation-play-state:running}@keyframes liquid-wave{to{transform:translateX(-50%) rotate(360deg)}}
...
@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important;transition:none!important;animation:none!important}.liquid-button.is-loading{--liquid-level:18%}}
'''
html=r'''<!doctype html><html lang="zh-CN"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>JT 灵感工作台</title><style>
...
<header class="topbar"><a class="brand" href="/promptgen"><span class="brand-mark">JT</span><span>JT 灵感工作台</span></a><nav class="topnav"><a class="topnav-link active" href="/promptgen">创作台</a><a class="topnav-link" href="/original-sketch">原始铅绘</a><a class="topnav-link" href="/original-graphic">原始古风</a><a class="topnav-link" href="/video">视频</a></nav><div class="topbar-tools"><span class="connection-dot" title="服务在线"></span><button class="topbar-action" id="favOpen">♥ 收藏</button><button class="topbar-action" id="histOpen">⌛ 历史</button></div></header>
...
function setLiquidLoading(button,loading){button.classList.toggle('is-loading',loading);button.setAttribute('aria-busy',loading?'true':'false')}
