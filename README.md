...
用户追加上线及付费测试授权后，`962ece1` 已通过正式发布器上线。Image 2 单次真实测试
109 秒完成、864×1536；当前后端和前端资源摘要均绑定新证据。发布检查通过，浏览器验证
三页切换/前进后退无文档重载、黑洞单 Renderer。发布详情见性能交付文档的上线补充。
下方旧分支和部署信息是历史快照。
